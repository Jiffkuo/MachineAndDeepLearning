...
with tf.name_scope("eval"):
    ...
    acc_name = "accuracy(batch_size:'%s', learning_rate:'%s')" %(batch_size,learning_rate)
...
with tf.Session() as sess:
    ...
    train_writer = tf.summary.FileWriter("/tmp/tkuo/tensorboard/p1/train", sess.graph)
    test_writer = tf.summary.FileWriter("/tmp/tkuo/tensorboard/p1/test", sess.graph)
    loss_writer = tf.summary.FileWriter("/tmp/tkuo/tensorboard/p1/loss", sess.graph)
    loss_name = "loss(batch_size:'%s', learning_rate:'%s')" %(batch_size,learning_rate)
